...
# create CNN with three dense layers with respectively 50, 35 and finally 2 neurons
...
# create a video capture script and implement the cnn model to detect the presence of facial mask or not.
